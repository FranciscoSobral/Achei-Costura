...
function InfoCostureiroPage() {
  ...
  const nomeExibido = contatoVisivel ? costureiro.nome : "Profissional Oculto";
    ...
    <div className="info-costureiro-container">
      ...
      <div className="perfil-header">
        <img 
            ...
            alt={costureiro.nome} 
            className={`perfil-avatar ${!contatoVisivel ? 'blur-avatar' : ''}`} 
        />
        <div className="perfil-dados">
          {/* AQUI ESTÁ A MUDANÇA: Exibe "Profissional Oculto" se bloqueado */}
          <h1>{nomeExibido}</h1>
            ...
            <div className="info-card">
              ...
              {contatoVisivel ? (
                <div className="contato-revelado">
                  {/* Simulando o desbloqueio do número */}
