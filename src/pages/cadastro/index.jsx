...
function CadastroPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log('📝 Dados antes do envio (Passo 1 e 2):', data);
        ...
        // Em vez de chamar register(), vamos para o Passo 3
        console.log('✅ Redirecionando para CadastroStep3');
        
        navigate('/cadastrostep3', { 
            state: { previousData: userData } 
        });
    };
        ...
        <div className="cadastro-container">
            <form onSubmit={handleSubmit} className="cadastro-card">
                ...
                <div className="form-progress">
                    ...
                    {/* --- ADIÇÃO SOLICITADA: VISUALIZAÇÃO DO PASSO 3 e 4 --- */}
                ...
                <div className="form-navigation">
                    ...
                    <button 
                        ...
                        disabled={loading}
                    >
                        {/* Texto alterado apenas aqui */}
                        {loading ? 'Processando...' : 
                         currentStep === 1 ? 'Avançar' : 'Próxima Etapa'}
                    </button>
                </div>
